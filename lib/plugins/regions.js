  ...
  _createClass(Regions, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (this.props.wavesurfer.regions && this.props.wavesurfer.regions.list) {
        Object.keys(this.props.wavesurfer.regions.list).forEach(function (currentKey) {
          _this2.props.wavesurfer.regions.list[currentKey].remove();
        });
      }
    ...
    value: function _init() {
      ...
      REGIONS_EVENTS.forEach(function (e) {
        var propCallback = _this4.props['on' + capitaliseFirstLetter(e)];
    ...
    value: function _hookUpRegionEvents(region) {
      ...
      REGION_EVENTS.forEach(function (e) {
        var propCallback = _this5.props['onSingleRegion' + capitaliseFirstLetter(e)];
        var wavesurfer = _this5.props.wavesurfer;
